...
class KalmanFilter(object):
    ...
    The 8-dimensional state space
        ...
        x, y, a, h, p, vx, vy, va, vh, vp

    contains the bounding box center position (x, y), aspect ratio a, height h,
    detection confidence p and their respective velocities.
    ...
    def initiate(self, measurement):
        ...
        ----------
        measurement : ndarray
            Bounding box coordinates (x, y, a, h, p) with center position (x, y),
            aspect ratio a, height h, and detection confidence p.
        ...
        std = [
            ...
            10 * self._std_weight_velocity * measurement[3],
            1e-5]                                                            #add
        std = list((1 - measurement[4]) * np.array(std))                     #add
    ...
    def update(self, mean, covariance, measurement):
        ...
        covariance : ndarray
            The state's covariance matrix (10x10 dimensional).
        measurement : ndarray
            The 5 dimensional measurement vector (x, y, a, h, p), where (x, y)
            is the center position, a the aspect ratio, h the height, and p the
            detection confidence of the bounding box.
    ...
    def gating_distance(self, mean, covariance, measurements,
        ...
        measurements : ndarray
            ...
            format (x, y, a, h, p) where (x, y) is the bounding box center
            position, a the aspect ratio, h the height, and p the
            detection confidence of the bounding box.
